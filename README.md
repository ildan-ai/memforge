...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20114965.svg)](https://doi.org/10.5281/zenodo.20114965) **Current release: v0.5.5** (most-recent Zenodo deposit: v0.5.3) ([PyPI](https://pypi.org/project/ildan-memforge/) | [CHANGELOG](./CHANGELOG.md) | [spec](./spec/SPEC.md))
...
memforge --version                  # memforge 0.5.5
